...
#define xrayrange()	((Xray_vision ? 3 : -1) + ((Role_if(PM_MONK) && ublindf && ublindf->oartifact == ART_EYE_OF_THE_OVERWORLD) ? ((u.ulevel+1)/10) : 0) + (u.sealsActive&SEAL_ORTHOS ? spiritDsize() + 1 : 0) + (Race_if(PM_ETHEREALOID)?3 + u.ulevel/7:0))
