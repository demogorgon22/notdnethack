...
#define AYM							(LAST_WARD+6)
#define BALAM						(LAST_WARD+7)
#define BERITH						(LAST_WARD+8)
#define BUER						(LAST_WARD+9)
#define CHUPOCLOPS					(LAST_WARD+10)
#define DANTALION					(LAST_WARD+11)
