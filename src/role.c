...
{	{"Archeologist", 0}, {
	...
	ART_ITLACHIAYAQUE,
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_DWARF|SA_GNOME|SA_CLOCKWORK|SA_VAMPIRE|SA_HALF_DRAGON|SA_FORMIAN, ROLE_MALE|ROLE_FEMALE |
...
{	{"Anachrononaut", 0}, {
	...
	ART_ANNULUS,
	SA_HUMAN|SA_DWARF|SA_ELF|SA_VAMPIRE|SA_HALF_DRAGON|SA_CLOCKWORK, ROLE_MALE|ROLE_FEMALE |
...
{	{"Barbarian", 0}, {
	...
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_ORC|SA_VAMPIRE|SA_HALF_DRAGON|SA_CENTAUR, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  16,  7,  7, 15, 16,  6 },
	{  30,  6,  7, 20, 30,  7 },
...
{	{"Binder", 		 0}, {
	...
	ART_PEN_OF_THE_VOID,
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_DWARF|SA_GNOME|SA_ELF|SA_ORC|SA_CLOCKWORK|SA_VAMPIRE|SA_HALF_DRAGON|SA_CHIROPTERAN|SA_YUKI_ONNA|SA_FORMIAN|SA_DRIDER|SA_CENTAUR|SA_SILVERMAN, ROLE_MALE|ROLE_FEMALE |
...
{	{"Convict", 0}, {
	...
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_DWARF|SA_GNOME|SA_ORC|SA_ELF|SA_VAMPIRE|SA_HALF_DRAGON|SA_CHIROPTERAN|SA_YUKI_ONNA|SA_DRIDER, ROLE_MALE|ROLE_FEMALE |
	  ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  10,  7,  7,  7, 13,  6 },
	{  20, 20, 10, 20, 20, 10 },
...
{	{"Healer", 0}, {
	...
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_ELF|SA_GNOME|SA_YUKI_ONNA|SA_CENTAUR|SA_DRIDER, ROLE_MALE|ROLE_FEMALE | ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{   7, 13, 11,  7, 11, 16 },
	{   5, 30, 20, 15, 25, 5 },
	/* Init   Lower  Higher */
...
{	{"Monk", 0}, {
	...
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_CLOCKWORK|SA_CHIROPTERAN|SA_HALF_DRAGON|SA_YUKI_ONNA, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  10,  7,  8,  8,  7,  7 },
	{  25, 10, 20, 20, 15, 10 },
...
{	{"Madman", "Madwoman"}, {
	...
	SA_HUMAN|SA_DWARF|SA_GNOME|SA_ORC|SA_ELF|SA_VAMPIRE|SA_HALF_DRAGON|SA_YUKI_ONNA|SA_TIEFLING|SA_AASIMAR, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   7, 10, 3, 10,  7, 10 },
	{  10, 10, 3, 20, 20, 30 },
...
{	{"Nobleman", "Noblewoman"}, {
	...
	SA_DWARF|SA_ELF|SA_HUMAN|SA_VAMPIRE|SA_HALF_DRAGON, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   10,10,  7, 10,  7,  7 },
	{  20, 18, 10, 20, 15, 17 },
...
{	{"Priest", "Priestess"}, {
	...
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_ELF|SA_CLOCKWORK|SA_HALF_DRAGON|SA_CHIROPTERAN, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   7,  7, 10,  7,  7,  7 },
	{  15, 10, 30, 15, 20, 10 },
...
{	{"Pirate", 0}, {
	...
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_ELF, ROLE_MALE|ROLE_FEMALE |
...
{	{"Rogue", 0}, {
	...
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_ORC|SA_VAMPIRE|SA_ELF|SA_HALF_DRAGON|SA_CHIROPTERAN|SA_SILVERMAN, ROLE_MALE|ROLE_FEMALE |
	  ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   7,  7,  7, 10,  7,  6 },
	{  20, 10, 10, 30, 20, 10 },
...
{	{"Ranger", 0}, {
	...
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_ELF|SA_GNOME|SA_ORC|SA_HALF_DRAGON|SA_CHIROPTERAN|SA_CENTAUR, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  13, 13, 13,  9, 13,  7 },
	{  30, 10, 10, 20, 20, 10 },
...
{	{"Tourist", 0}, {
	...
	SA_HUMAN, ROLE_MALE|ROLE_FEMALE | ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{   7, 10,  6,  7,  7, 10 },
	{  15, 10, 10, 15, 30, 20 },
	/* Init   Lower  Higher */
...
{	{"Undead Hunter", 0}, {
	...
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_VAMPIRE|SA_ORC|SA_YUKI_ONNA, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   7, 10, 10,  7,  7,  7 },
	{  18, 10, 10, 24, 18, 10 },
...
{	{"Wizard", 0}, {
	...
	SA_HUMAN|SA_TIEFLING|SA_AASIMAR|SA_ELF|SA_GNOME|SA_ORC|SA_VAMPIRE|SA_HALF_DRAGON, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   7, 10,  7,  7,  7,  7 },
	{  10, 30, 10, 20, 20, 10 },
...
{	{"Ranger", 0}, {
	...
	ART_LONGBOW_OF_DIANA,
	SA_HUMAN|SA_ELF|SA_GNOME|SA_ORC | ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL|ROLE_CHAOTIC,
	// Str Int Wis Dex Con Cha
	{  13, 13, 13,  9, 13,  7 },
	{  30, 10, 10, 20, 20, 10 },
...
{	{"Undefined", 0}, { {0, 0}, {0, 0}, {0, 0},
	...
	GOD_NONE, GOD_NONE, GOD_NONE, GOD_NONE, "Xxx", "home", "locate",
...
{	"silverknight", "silverknight", "silverknight-kind", "Skn", 0,
	...
	SA_SILVERMAN,
	MA_INSECTOID|MA_HUMAN, 0, ~0, /* Everyone */
	/*  Str    Int Wis Dex Con Cha */
	{    3,     3,  3,  3,  3,  3 },
	{ STR18(100), 18, 18, 18, 18, 18 },
	/* Init   Lower  Higher */
	...
	int rolenum, racenum;
{
	...
	return (racenum >= 0 && racenum < SIZE(races)-1 &&
		(roles[rolenum].marace & races[racenum].race_code));
}
	...
	int rolenum;
{
	...
	for (i = 0; races[i].noun; i++)
	    if (roles[rolenum].marace & races[i].race_code)
	    	n++;
...
#ifdef CONVICT
	|| (roles[rolenum].malenum==PM_CONVICT && aligns[alignnum].allow & roles[rolenum].allow & ROLE_ALIGNMASK && roles[rolenum].marace & races[racenum].race_code)
#endif
		));
}
...
#ifdef CONVICT
		|| (roles[rolenum].malenum==PM_CONVICT && aligns[i].allow & roles[rolenum].allow & ROLE_ALIGNMASK && roles[rolenum].marace & races[racenum].race_code)
#endif
			)
	    	n++;
...
int rolenum, racenum, gendnum, alignnum;
{
...
#ifdef CONVICT
		|| (roles[rolenum].malenum==PM_CONVICT && aligns[alignnum].allow & allow & ROLE_ALIGNMASK && roles[rolenum].marace & races[racenum].race_code)
#endif
	))
		return FALSE;
	return TRUE;
	...
	for (i = 0; i < SIZE(roles)-1; i++) {
	    allow = roles[i].allow;
	    if (racenum >= 0 && racenum < SIZE(races)-1 &&
		    !(roles[i].marace & races[racenum].race_code))
			continue;
	    if (gendnum >= 0 && gendnum < ROLE_GENDERS &&
		    !(allow & genders[gendnum].allow & ROLE_GENDMASK))
			continue;
	    if (alignnum >= 0 && alignnum < ROLE_ALIGNS &&
		    !(allow & aligns[alignnum].allow & ROLE_ALIGNMASK
#ifdef CONVICT
			|| (roles[rolenum].malenum==PM_CONVICT && aligns[alignnum].allow & allow & ROLE_ALIGNMASK && roles[i].marace & races[racenum].race_code)
#endif
		))
			continue;
	    return TRUE;
...
int rolenum, racenum, gendnum, alignnum;
{
	...
	if (rolenum >= 0 && rolenum < SIZE(roles)-1 &&
		!(races[racenum].race_code & roles[rolenum].marace))
	    return FALSE;
	if (gendnum >= 0 && gendnum < ROLE_GENDERS &&
		!(allow & genders[gendnum].allow & ROLE_GENDMASK))
	    return FALSE;
	...
	for (i = 0; i < SIZE(races)-1; i++) {
	    allow = races[i].allow;
	    if (rolenum >= 0 && rolenum < SIZE(roles)-1 &&
		    !(races[i].race_code & roles[rolenum].marace))
		continue;
	    if (gendnum >= 0 && gendnum < ROLE_GENDERS &&
		    !(allow & genders[gendnum].allow & ROLE_GENDMASK))
		continue;
	    if (alignnum >= 0 && alignnum < ROLE_ALIGNS &&
		    !(allow & aligns[alignnum].allow & ROLE_ALIGNMASK
#ifdef CONVICT
			|| (roles[rolenum].malenum==PM_CONVICT && aligns[alignnum].allow & roles[rolenum].allow & ROLE_ALIGNMASK && roles[rolenum].marace & races[i].race_code)
#endif
	))
		continue;
	    return TRUE;
...
#ifdef CONVICT
		|| (roles[rolenum].malenum==PM_CONVICT && allow & roles[rolenum].allow & ROLE_ALIGNMASK && roles[rolenum].marace & races[racenum].race_code)
#endif
	))
	    return FALSE;
	return TRUE;
...
int newgame;
{
	...
	if (flags.pantheon == -1) {		/* new game */
		...
		if(Role_if(PM_EXILE)){
			do{
				do flags.panLgod = randrole(AM_LAWFUL); while (!roles[flags.panLgod].lgod || philosophy_index(roles[flags.panLgod].lgod));
				do flags.panNgod = randrole(AM_NEUTRAL); while (!roles[flags.panNgod].ngod || philosophy_index(roles[flags.panNgod].ngod));
				do flags.panCgod = randrole(AM_CHAOTIC); while (!roles[flags.panCgod].cgod || philosophy_index(roles[flags.panCgod].cgod));
				do flags.panVgod = randrole(0); while (!roles[flags.panVgod].vgod || philosophy_index(roles[flags.panVgod].vgod));
			} while(flags.panLgod == flags.panNgod
					|| flags.panLgod == flags.panCgod
					|| flags.panNgod == flags.panCgod
					|| flags.panLgod == flags.panVgod 
					|| flags.panNgod == flags.panVgod 
					|| flags.panCgod == flags.panVgod 
					);
		}
	}
