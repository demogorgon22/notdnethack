...
{	{"Anachrononaut", 0}, {
	...
	ART_ANNULUS,
	SA_HUMAN|SA_DWARF|SA_ELF|SA_VAMPIRE|SA_HALF_DRAGON|SA_CLOCKWORK|SA_SALAMANDER|SA_ETHEREALOID|SA_ENT, ROLE_MALE|ROLE_FEMALE |
...
{	{"Illithanachronounbinder", 		 0}, {
	...
	SA_HUMAN|SA_DWARF|SA_GNOME|SA_ELF|MA_ORC|SA_HALF_DRAGON|SA_CHIROPTERAN|SA_SALAMANDER|SA_ENT|SA_YUKI_ONNA, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL,
	/* Str Int Wis Dex Con Cha */
	{  12, 10,  7, 12,  12,  7 },
	{  24, 20, 15, 20, 24, 15 },
